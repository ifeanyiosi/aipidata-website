...
export default function HeroFive() {
  ...
  return (
    <div className="flex min-h-screen bg-[#f3f3f3] relative z-[10] lg:px-[100px] px-[30px] justify-center py-[50px] flex-col items-center w-full">
      <div className="flex flex-col items-center max-w-[1200px] w-full  justify-between">
        ...
        <div className="lg:w-[65%] flex flex-col items-center justify-center w-full">
          <h3 className="text-[18px] font-[700]  text-[#000]">
            Planning begins by understanding the right goals
          </h3>
          <p className="text-[16px]  mb-[25px] text-[#000]">
