    ...
    <main className="flex min-h-screen pb-[70px]  relative z-[10] py-36 flex-col items-center w-full  px-[30px] md:px-[100px]  ">
      ...
      <div className=" w-full flex items-center flex-col">
        <div className="w-full flex items-center justify-start">
          <motion.h1 className="text-[25px] lg:text-[28px] text-[#fff] text-left lg:text-left py-[70px] lg:px-[35px] my-[10px] ">
            Imagine you were really wow&apos;d by a software experience.
          </motion.h1>
        </div>

        <div className="w-full flex items-center justify-end">
          <motion.h1 className="text-[25px] lg:text-[28px] text-[#fff] text-right lg:text-right py-[70px] lg:px-[35px] my-[10px]">
            With us you don&apos;t need to imagine it
          </motion.h1>
        </div>

        <motion.h1 className="text-[20px]  text-[#fff] mx-auto lg:max-w-[600px] text-center">
